...
class CircleChanger(object):
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        return math.sqrt((self.circle.center.x-point.x)**2+(self.circle.center.y-point.y)**2)
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        r_color = self.colors[r_index]
        rad = self.circle.radius
        if rad + amount_to_swell_or_shrink >= 1:
            self.circle.radius = rad + amount_to_swell_or_shrink
        else:
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        for __ in range(times_to_swell_or_shrink):
    ...
    def swallow(self, other_circle_changer):
        ...
        dy = other_circle_changer.circle.center.y-self.circle.center.y
        dx = other_circle_changer.circle.center.x-self.circle.center.x
        x = self.circle.center.x+dx/2
        y = self.circle.center.y+dy/2
        colors = self.colors + other_circle_changer.colors
        newCircleChanger = CircleChanger(x, y, rad, 'red', colors)
